        ...
        <section id="about">
            ...
            >
                <div>
                    ...
                    />
                    <motion.div
                        className="absolute top-0 left-0 mx-auto flex items-center sm:items-start xl:items-center justify-center sm:justify-end w-full h-full z-10"
                        initial="hidden"
                        whileInView="visible"
                    ...
                    >
                        <div className="text-primary-background sm:w-1/2 mx-auto w-11/12 sm:mr-10 xl:mr-0 xl:mx-20 text-center sm:text-start mt-10 sm:mt-25 xl:mt-0">
                            ...
                            <p className="text-2xl sm:text-xl md:text-2xl lg:text-4xl 3xl:text-5xl xl:mt-4">
